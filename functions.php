...
if ( ! function_exists('ccc_theme_enqueue') ) :
	...
	function ccc_theme_enqueue()
    {
      ...
      // enqueue CSS for front page
        ...
        wp_enqueue_style( 'chld_thm_owl_parent', trailingslashit( get_template_directory_uri() ) . '/vendor/smashingboxes/owlcarousel/assets/owl.carousel.css' );
        ...
        wp_enqueue_script( 'chld_thm_owl', trailingslashit( get_template_directory_uri() ) . 'vendor/smashingboxes/owlcarousel/owl.carousel.min.js');
        wp_enqueue_script( 'chld_thm_photoswipe', trailingslashit( get_template_directory_uri() ) . '/vendor/dimsemenov/PhotoSwipe/photoswipe.min.js');
        wp_enqueue_script( 'chld_thm_photoswipe-ui', trailingslashit( get_template_directory_uri() ) . '/vendor/dimsemenov/PhotoSwipe/photoswipe-ui-default.min.js');
